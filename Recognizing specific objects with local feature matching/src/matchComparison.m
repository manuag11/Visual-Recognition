...
for scenenum = 1:length(scenenames)
    ...
    fprintf('Showing the matches with lines connecting after application of thresholded nearest neighbor outlier rejection algorithm\n');
    ...
    clf;
    showLinesBetweenMatches(im1, im2, f1, f2, matchMatrix);
    fprintf('Showing the matches with lines connecting after application of thresholded ratio test outlier rejection algorithm\n');
    fprintf('Type dbcont to continue.\n');
    fprintf('Number of matches = %d\n',size(matchMatrix,2));
    keyboard;
    ...
    fprintf('Showing the final set of matches after outlier rejection with RANSAC with lines connecting.  Type dbcont to continue.\n');
    fprintf('Number of matches = %d\n',size(matchMatrix,2));
    keyboard;
    fprintf('scenenum=%d\n', scenenum);
end